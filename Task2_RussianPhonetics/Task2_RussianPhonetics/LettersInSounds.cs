...
namespace Task2_RussianPhonetics
{
    ...
    public class LettersInSounds
    {
        ...
        public LettersInSounds(string originalStr)
        {
            ...
            CheckOnValudString(originalString);
        ...
        /// </summary>
        public void CheckOnValudString(string originalStr)
        {
            ...
            foreach (char c in originalStr)
            {
                ...
                {
                    indexShockVowel = originalStr.IndexOf(c);
                    countSyllable++;
                }
            }
            ...
            if (originalStr.IndexOf('ё') != -1)
            {
                indexShockVowel = originalString.IndexOf('ё');
            }
            if (countSyllable == 1 && countPlus == 0)
            {
                originalString = originalStr.Insert(indexShockVowel + 1, "+");
            }
        }
        /// <summary>
